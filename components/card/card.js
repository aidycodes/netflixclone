...
const Card = (props) => {
    ...
    const {imgUrl = "/images/cliffor.webp", size = "medium"} = props
  ...
  return (
    <div className={styles.container}>
        <motion.div   whileHover={{scale: 1.2, transition: { duration: 0.5 },}} className={cls(classMap[size], styles.imgMotionWrapper )}>
